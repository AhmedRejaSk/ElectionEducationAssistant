...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      <header className="bg-blue-900 text-white py-8 px-6 text-center shadow-md relative">
        <div className="absolute top-4 right-6">
          <select 
            value={appLanguage}
            onChange={(e) => setAppLanguage(e.target.value)}
            className="px-3 py-1.5 border border-blue-700 bg-blue-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-white text-sm"
          >
        ...
        <p className="mt-2 text-blue-200 text-lg">{t.subtitle}</p>
      </header>
